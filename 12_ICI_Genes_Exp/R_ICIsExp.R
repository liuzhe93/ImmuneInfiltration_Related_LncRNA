...
library("survival")
library("survminer")
#rt=read.table("/Users/liuzhe/Desktop/cityu/LncRNA_CRC/analysis/06_multivariateCox_regression/risk.txt",header=T,sep="\t")
...
#res.cut
#          cutpoint statistic
#riskScore 1.254404  4.645349
#rt$group=ifelse(rt$riskScore>1.254404,"high","low")
